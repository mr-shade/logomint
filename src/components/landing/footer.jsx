...
export function Footer() {
  return (
    <footer className="bg-background border-t py-12 px-4 md:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4">
              AI-powered logo generation for modern businesses. Create stunning brand identities in minutes.
            </p>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} LogoMint. All rights reserved.
          </p>
